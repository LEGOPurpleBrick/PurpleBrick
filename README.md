...
* For some doors, below the **Hit:** field there will also be a note on the door, if there is a note saying the door is **Inactive** this means attempting to hit it will not result in anything, if a note says **Inactive until.../Active after**, this means a condition neeeds to be met for the door to be hittable, there is also some other notes, however those should be self-explanatory.
